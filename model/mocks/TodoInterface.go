...
// GetTodoByDate provides a mock function with given fields: page, content, userID, date
func (_m *TodoInterface) GetTodoByDate(page int, content int, userID uint, date string) []model.Todo {
	ret := _m.Called(page, content, userID, date)

	var r0 []model.Todo
	if rf, ok := ret.Get(0).(func(int, int, uint, string) []model.Todo); ok {
		r0 = rf(page, content, userID, date)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Todo)
		}
...
// GetTodoByStatus provides a mock function with given fields: page, content, userID, status
func (_m *TodoInterface) GetTodoByStatus(page int, content int, userID uint, status string) []model.Todo {
	ret := _m.Called(page, content, userID, status)

	var r0 []model.Todo
	if rf, ok := ret.Get(0).(func(int, int, uint, string) []model.Todo); ok {
		r0 = rf(page, content, userID, status)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Todo)
		}
...
// GetTodos provides a mock function with given fields: page, content, userID
func (_m *TodoInterface) GetTodos(page int, content int, userID uint) []model.Todo {
	ret := _m.Called(page, content, userID)

	var r0 []model.Todo
	if rf, ok := ret.Get(0).(func(int, int, uint) []model.Todo); ok {
		r0 = rf(page, content, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]model.Todo)
		}
